...
class Query extends Component {
    ...
    setModalVisible(visible) {
        this.setState({JumpToPageVisible: visible});
    }
...
//mainattachid是n，第一张就是mainattachid的图片，后边的是1，2，3.。。类推
    ...
    buttoncommit(){//saveMode:1 插入 2 覆盖 3 取消
        ...
        let originCommodityId = this.props.commodityId;
        ...
        return (
            <View style={{flex: 1,backgroundColor:'#fff'}}>
                ...
                <Modal
                    animationType={"slide"}
                    transparent={true}
                    visible={this.state.JumpToPageVisible}
                    onRequestClose={() => {
                        this.setModalVisible(false);
                    }}
                >
                    <View style={{height: 300,width:300, marginTop: 50,marginLeft:50,alignItems:'center',justifyContent:'center',borderWidth:1,backgroundColor:'#fff'}}>
                        ...
                        <View style={{flex:2,justifyContent:'center',alignItems:'center'}}>
                            <View style={{flex: 1, flexDirection: 'row', alignItems: 'center'}}>
                                <TextInput
                                    style={{height: 40,flex: 1,paddingLeft: 20,paddingRight: 10,paddingTop: 2,paddingBottom: 2,fontSize:setSpText(30)}}
                        ...
                        <View style={{flex:1}}>
                            ...
                            alignItems: 'center'
                                ...
                                <Text style={{fontSize:setSpText(30), color: '#fff'}}>{_name.返回}</Text>
                            </TouchableOpacity>
                        </View>
